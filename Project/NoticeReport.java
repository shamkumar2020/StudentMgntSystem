...
import java.sql.*;
class NoticeReport extends JPanel
{
	Connection con=null;
	Statement pst=null;
	ResultSet rs=null;
	...
	NoticeReport()
	{
		...
		String sql1="SELECT notice.regno, notice.notice, notice.dep, notice.mob FROM notice";
   ...
   public void paintComponent(Graphics g)
		{
			...
			Image img=kit.getImage("img\\NoticeReg.jpg");
	   ...
	   {
		   NoticeReport obj=new NoticeReport();
		   obj.setVisible(true);
	   }

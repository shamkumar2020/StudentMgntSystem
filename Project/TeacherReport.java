...
import java.sql.*;
class TeacherReport extends JPanel
{
	Connection con=null;
	Statement pst=null;
	ResultSet rs=null;
	...
	TeacherReport()
	{
		...
		String sql1="SELECT teacher.regno, teacher.teachn, teacher.add, teacher.mob, teacher.edu, teacher.exp, teacher.sal FROM teacher";
   ...
   public void paintComponent(Graphics g)
		{
			...
			Image img=kit.getImage("img\\TeacherReport.jpg");
	   ...
	   {
		   TeacherReport obj=new TeacherReport();
		   obj.setVisible(true);
	   }

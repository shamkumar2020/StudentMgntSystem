...
import java.sql.*;
class CourceReport extends JPanel
{
	Connection con=null;
	Statement pst=null;
	ResultSet rs=null;
    ...
    CourceReport()
	{
		...
		String sql1="SELECT cource.regno, cource.studn, cource.add, cource.mob, cource.cource, cource.year, cource.fees FROM cource";
   ...
   public void paintComponent(Graphics g)
		{
			...
			Image img=kit.getImage("img\\CourseRep.jpg");
	   ...
	   {
		   CourceReport obj=new CourceReport();
		   obj.setVisible(true);
	   }

...
import java.sql.*;
class ComplaintReport extends JPanel
{
	Connection con=null;
	Statement pst=null;
	ResultSet rs=null;
	...
	ComplaintReport()
	{
		...
		String sql1="SELECT complaint.regno, complaint.comp, complaint.dep, complaint.mob FROM complaint";
   ...
   public void paintComponent(Graphics g)
		{
			...
			Image img=kit.getImage("img\\Complaint.jpg");
	   ...
	   {
		   ComplaintReport obj=new ComplaintReport();
		   obj.setVisible(true);
	   }
